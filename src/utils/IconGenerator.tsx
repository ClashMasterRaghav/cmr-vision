...
export const generateIconSVG = (appType: string, size: number = 32): string => {
  ...
  switch (appType) {
    case 'browser':
      return wrapSVG(`
        <circle cx="12" cy="12" r="10" fill="#1E88E5" stroke="${baseStroke}" stroke-width="1" />
        <circle cx="12" cy="12" r="4" fill="#90CAF9" stroke="${baseStroke}" stroke-width="0.5" />
    ...
    case 'videoPlayer':
      return wrapSVG(`
        <rect x="2" y="4" width="20" height="16" rx="2" fill="#00529B" stroke="${baseStroke}" stroke-width="0.5" />
    ...
    case 'calculator':
      return wrapSVG(`
        <rect x="4" y="2" width="16" height="20" rx="2" fill="#E8E8E8" stroke="${baseStroke}" stroke-width="0.5" />
        <rect x="6" y="4" width="12" height="4" fill="#82B1FF" stroke="${baseStroke}" stroke-width="0.5" />
        <circle cx="8" cy="11" r="1.2" fill="#64B5F6" />
        <circle cx="12" cy="11" r="1.2" fill="#64B5F6" />
        <circle cx="16" cy="11" r="1.2" fill="#64B5F6" />
        <circle cx="8" cy="15" r="1.2" fill="#64B5F6" />
        <circle cx="12" cy="15" r="1.2" fill="#64B5F6" />
        <circle cx="16" cy="15" r="1.2" fill="#64B5F6" />
        <circle cx="8" cy="19" r="1.2" fill="#64B5F6" />
        <circle cx="12" cy="19" r="1.2" fill="#64B5F6" />
        <circle cx="16" cy="19" r="1.2" fill="#FF7043" />
      `);
      
    case 'calendar':
      return wrapSVG(`
        <rect x="3" y="4" width="18" height="16" rx="2" fill="${baseFill}" stroke="${baseStroke}" stroke-width="0.5" />
        <rect x="3" y="4" width="18" height="4" fill="#E57373" stroke="${baseStroke}" stroke-width="0.5" />
        <line x1="7" y1="2" x2="7" y2="6" stroke="${baseStroke}" stroke-width="1" />
        <line x1="17" y1="2" x2="17" y2="6" stroke="${baseStroke}" stroke-width="1" />
        <line x1="7" y1="12" x2="17" y2="12" stroke="${baseStroke}" stroke-width="0.5" />
        <line x1="7" y1="16" x2="17" y2="16" stroke="${baseStroke}" stroke-width="0.5" />
        <circle cx="7" cy="10" r="1" fill="#4FC3F7" />
        <circle cx="11" cy="10" r="1" fill="#4FC3F7" />
        <circle cx="15" cy="10" r="1" fill="#4FC3F7" />
        <circle cx="7" cy="14" r="1" fill="#4FC3F7" />
        <circle cx="11" cy="14" r="1" fill="#4FC3F7" />
        <circle cx="15" cy="14" r="1" fill="#4FC3F7" />
      `);
      
    case 'myComputer':
      return wrapSVG(`
        <rect x="4" y="6" width="16" height="12" rx="1" fill="#90CAF9" stroke="${baseStroke}" stroke-width="0.5" />
    ...
    case 'recycle':
      return wrapSVG(`
        <path d="M12,3 L16,8 L8,8 Z" fill="#4CAF50" stroke="${baseStroke}" stroke-width="0.5" />
        <path d="M5,10 L9,15 L1,15 Z" fill="#4CAF50" stroke="${baseStroke}" stroke-width="0.5" transform="rotate(15 5 12)" />
        <path d="M19,10 L23,15 L15,15 Z" fill="#4CAF50" stroke="${baseStroke}" stroke-width="0.5" transform="rotate(-15 19 12)" />
